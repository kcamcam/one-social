class UsersController < ApplicationController
  ...
  def update
    @user = User.find(params[:id])
    @social = @user.social_medium
    @socialarray = ["twitter","instagram","youtube","facebook","googleplus","pinterest","snapchat","flickr","whatsapp","messenger","medium","reddit","hackernews","github","keybase","devpost","devto","angel","linkedin","steam","origin","twitch","discord","bitcoin","ethereum"]
