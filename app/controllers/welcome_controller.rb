class WelcomeController < ApplicationController
  ...
  def index
    ...
    @socialarray = ["instagram","twitter","youtube","facebook","googleplus","linkedin","snapchat","messenger","wire","telegram","soundcloud","apple","spotify","pinterest","tumblr","reddit","medium","hackernews","github","keybase","devto","devpost","angel","twitch","origin","steam","xbox","discord","paypal","bitcoin"]
  end
end
